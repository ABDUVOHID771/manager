package com.example.springmanager.utils;
...
public class LoggingInterceptor extends HandlerInterceptorAdapter {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        ...
        if (ex != null) {
            com.example.springmanager.utils.LoggingInterceptor.LOG.error(logMessage.toString(), ex);
        } else {
            com.example.springmanager.utils.LoggingInterceptor.LOG.info(logMessage.toString());
        }

package com.example.springmanager.config;

import com.example.springmanager.jwt.JwtRequestFilter;
import com.example.springmanager.jwt.JwtUnAuthorizedResponse;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/authenticate", "/rest/user/register","/rest/orders/all").permitAll()
